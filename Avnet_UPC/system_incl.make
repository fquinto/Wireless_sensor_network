...
# Project:C:\Datos\Proyecto\PlacaSpartan3A\Avnet\Avnet_UPC\system.xmp
#
...
DEVICE = xc3s400aft256-4

LANGUAGE = vhdl
GLOBAL_SEARCHPATHOPT =  -lp C:/Avnet_Repository
...
APPLICATION_OUTPUT_DIR = SDK/SDK_Workspace_35/application/Release
APPLICATION_OUTPUT = $(APPLICATION_OUTPUT_DIR)/application.elf
CYG_APPLICATION_OUTPUT_DIR = SDK/SDK_Workspace_35/application/Release
CYG_APPLICATION_OUTPUT = $(CYG_APPLICATION_OUTPUT_DIR)/application.elf
...
BRAMINIT_ELF_FILES =  $(CYG_APPLICATION_OUTPUT) 
BRAMINIT_ELF_FILE_ARGS =   -pe microblaze_0 $(APPLICATION_OUTPUT) 

ALL_USER_ELF_FILES = $(CYG_TESTAPP_MEMORY_MICROBLAZE_0_OUTPUT) $(CYG_TESTAPP_PERIPHERAL_MICROBLAZE_0_OUTPUT) $(CYG_APPLICATION_OUTPUT) 
...
SIMGEN_OPTIONS = -p $(DEVICE) -lang $(LANGUAGE) $(SEARCHPATHOPT) $(BRAMINIT_ELF_FILE_ARGS) $(MIX_LANG_SIM_OPT) -msg __xps/ise/xmsgprops.lst -s mti -X C:/Datos/Proyecto/PlacaSpartan3A/Avnet/Avnet_UPC/
...
implementation/cs_push_3bit_wrapper.ngc \
implementation/temp_sensor_wrapper.ngc \
implementation/flash_2mx16_wrapper.ngc \
...
implementation/msp430_uart_wrapper.ngc
...
TESTAPP_MEMORY_MICROBLAZE_0_CC_INFERRED_FLAGS= -mno-xl-soft-mul -mxl-barrel-shift -mxl-pattern-compare -mcpu=v8.00.a 
...
TESTAPP_PERIPHERAL_MICROBLAZE_0_SOURCES = TestApp_Peripheral_microblaze_0/src/TestApp_Peripheral.c TestApp_Peripheral_microblaze_0/src/xintc_tapp_example.c TestApp_Peripheral_microblaze_0/src/xgpio_tapp_example.c TestApp_Peripheral_microblaze_0/src/xiic_selftest_example.c TestApp_Peripheral_microblaze_0/src/xtmrctr_selftest_example.c TestApp_Peripheral_microblaze_0/src/xtmrctr_intr_example.c TestApp_Peripheral_microblaze_0/src/xuartlite_selftest_example.c 

TESTAPP_PERIPHERAL_MICROBLAZE_0_HEADERS = TestApp_Peripheral_microblaze_0/src/intc_header.h TestApp_Peripheral_microblaze_0/src/gpio_header.h TestApp_Peripheral_microblaze_0/src/iic_header.h TestApp_Peripheral_microblaze_0/src/tmrctr_header.h TestApp_Peripheral_microblaze_0/src/tmrctr_intr_header.h TestApp_Peripheral_microblaze_0/src/uartlite_header.h 
...
TESTAPP_PERIPHERAL_MICROBLAZE_0_CC_INFERRED_FLAGS= -mno-xl-soft-mul -mxl-barrel-shift -mxl-pattern-compare -mcpu=v8.00.a 
