...
{ ?>
				url: '../cgi-bin/recibir_linux_json.py?puerto=<?php echo $_SESSION['puerto']; ?>&velocidad=<?php echo $_SESSION['velocidad']; ?>&databit=<?php echo $_SESSION['databit']; ?>&stopbit=<?php echo $_SESSION['stopbit']; ?>&paridad=<?php echo $_SESSION['paridad']; ?>&control=<?php echo $_SESSION['control']; ?>&header=A',
<?php } ?>
<?php if (isset($_SESSION['OS']) && $_SESSION['OS']=="WINDOWS")
{ ?>
				url: '../cgi-bin/recibir_windows_json.py?puerto=<?php echo $_SESSION['puerto']; ?>&velocidad=<?php echo $_SESSION['velocidad']; ?>&databit=<?php echo $_SESSION['databit']; ?>&stopbit=<?php echo $_SESSION['stopbit']; ?>&paridad=<?php echo $_SESSION['paridad']; ?>&control=<?php echo $_SESSION['control']; ?>&header=A',
				/*url: 'json_data.php',*/
<?php } ?>
...
<div class="container">
<h1><?php echo( READ ); ?> <small><?php echo( GRAPHAP_MSG ); ?></small></h1>
<?php if ( isset($_SESSION['velocidad']) && $_SESSION['velocidad']!="" && isset($_SESSION['puerto']) && $_SESSION['puerto']!="" && isset($_SESSION['OS']) && $_SESSION['OS']!="" && (writable_port($_SESSION['puerto'])==1) )
{
?>
