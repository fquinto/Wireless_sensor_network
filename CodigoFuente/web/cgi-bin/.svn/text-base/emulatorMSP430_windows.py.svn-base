...
while True:
	...
	if (len(newdata) > 0):
		...
		#print ("newdata = ",newdata.decode('utf-8'))
		#print ("data = ",str(data))
		if (len(data) == 8):
			header = data[0:1]
			readwrite = data[1:2]
			...
			datamsg = data[4:7]
			print ("-------------------------------------")
			print ('RECIBIDO: '+ header + readwrite + address + datamsg + ' = ', end="")
			if (header == "A"):
				print ("AP ", end="")
				respuesta = "D"
			if (header == "B"):
			...
			if (address == "52"):
				...
				if (readwrite == "R"):
					if (datamsg == "000"):
						...
						estado = a + b + c
			if (address == "60"):
				print ("Set address ED ", end="")
				print (datamsg)
			if (address == "61"):
				print ("Set address AP ", end="")
				print (datamsg)
			if (address == "62"):
				if (datamsg == "000"):
					print ("Setup ED ")
