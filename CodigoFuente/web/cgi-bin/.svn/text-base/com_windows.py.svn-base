...
# CALL using browser:
# http://127.0.0.1/serie/cgi-bin/com_windows.py?puerto=COM9&velocidad=9600&databit=8&stopbit=1&paridad=none&control=none&veces=1&destino_msg=AP&rw=R&address=50&data=000&lang=es&debug=1
...
if ser.isOpen():
	try:
		...
		if ( rw_msg=="R" ):
			...
			print ("<br>")
			print (msg_recibido+message.decode('utf-8'))
			# ===========================================
	...
	except (IOError, TypeError) as err1:
		print (error_com + str(err1))
else:
    print (error_txt)
